...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/new-css.css') }}" rel="stylesheet">
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @if(app()->bound('restaurant'))
                            ...
                            <li class="{{ request()->routeIs('branch.customer-feedback') ? 'active' : '' }}">

                                <a href="{{ route('branch.customer-feedback', [
