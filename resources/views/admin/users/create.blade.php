                                    ...
                                    <div class="eht-fields-grid">
                                        ...
                                        <div class="eht-field">
                                            ...
                                            <input type="email" name="email" value="{{ old('email') }}"
                                                class="eht-input @error('email') is-invalid @enderror">
                                            @error('email') <small class="text-danger">{{ $message }}</small> @enderror
                                        </div>
                                        <div class="eht-field">
                                            <label>Password</label>
                                            <input type="password" name="password"
                                                class="eht-input @error('password') is-invalid @enderror">
                                        ...
                                        <div class="eht-field">
                                            ...
                                            <input type="text" name="phone" value="{{ old('phone') }}"
                                                class="eht-input @error('phone') is-invalid @enderror">
                                        ...
                                        <div class="eht-field">
                                            ...
                                            <input type="date" name="birth_date" value="{{ old('birth_date') }}"
                                                class="eht-input @error('birth_date') is-invalid @enderror">
                                        ...
                                        <div class="eht-field full-width">
                                            ...
                                            <textarea name="address" rows="6"
                                                class="eht-input">{{ old('address') }}</textarea>
