                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <form action="{{ route('restaurant.categories.destroy',['restaurant' => request()->route('restaurant'),'category' => $category->id]) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                            @csrf
                                            @method('DELETE')
