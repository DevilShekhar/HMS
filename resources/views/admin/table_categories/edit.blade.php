...
@section('content')
    <section class="section premium-dashboard">
        <div class="premium-page-head">
            ...
            <div class="premium-head-actions">
                <a href="{{ route('restaurant.table-categories.index',['restaurant' => request()->route('restaurant')]) }}" class="btn premium-btn ghost-btn">
    ...
    <section class="section premium-dashboard pt-0">
        <form action="{{ route('restaurant.table-categories.update',['restaurant' => request()->route('restaurant'), 'table_category' => $tableCategory->id]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $tableCategory->name) }}" class="form-control premium-input"  placeholder="Enter category name">
                                    @error('name')
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
