    ...
    <div class="eht-container">
        ...
        <div class="eht-header">
            <div class="eht-page-title">
                ...
                <p>Add a new subscription plan to the system</p>
            </div>
            ...
            <form method="POST" action="{{ route('subscription-plans.store') }}">
                ...
                <div class="eht-main-card">
                    <div class="eht-card-body">
                        <div class="eht-form-grid">
                            ...
                            <div class="eht-left-form">
                                ...
                                <p class="eht-subtext">Enter subscription plan details.</p>
                                ...
                                <div class="eht-fields-grid">
                                    ...
                                    <div class="eht-field">
                                        ...
                                        <input type="number" step="0.01" name="quarterly_price" value="{{ old('quarterly_price') }}"
                                    ...
                                    <div class="eht-field">
                                        ...
                                        <input type="number" step="0.01" name="half_yearly_price" value="{{ old('half_yearly_price') }}"
                    ...
                    <div class="eht-form-footer">
                        ...
                        <button type="reset" class="eht-btn eht-btn-ghost">
